...
interface ShipmentDetails {
  ...
  truckId: string;
  shipmentId: string;
  shipmentDestination: { location: string };
  shipmentOrigin: { location: string };
}

interface CustomSafetyFactors {
  [key: string]: string;
}
...
const SafetyCompliance = () => {
  ...
  const customSafetyFactors: CustomSafetyFactors = {
  ...
  const handleShowDetails = async (safetyFactor: string) => {
...
const handleViewImage = (safetyFactor: string, index: number) => {
  ...
  const ImageViewer = ({ imageUrl, handleCloseImage }: { imageUrl: string; handleCloseImage: () => void }) => {
    return (
