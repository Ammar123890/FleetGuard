...
const ViewShipment = () => {
  ...
  return (
    ...
    onMouseOver={(e) => e.target.style.backgroundColor = '#d9d9d9'} // Change color on hover
    onMouseOut={(e) => e.target.style.backgroundColor = '#e6e6e6'} // Revert to original color on mouse out
>
