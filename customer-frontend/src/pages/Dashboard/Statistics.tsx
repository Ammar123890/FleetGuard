  ...
  useEffect(() => {
    const fetchStatistics = async () => {
      try {
        ...
        const response = await fetch('https://fleet-guard.azurewebsites.net/api/customer/statistics/get', { headers });
        ...
        setStatistics([
          {
            ...
            stats: data.data.totalDashcams.toString(),
            icon: 'ri-webcam-line',
          ...
          },
          {
            ...
            stats: data.data.totalShipments.toString(),
            icon: 'ri-route-line',
            variant: 'text-bg-info',
          },
          {
            title: 'Total Trucks',
            stats: data.data.totalTrucks.toString(),
            icon: 'ri-truck-line',
