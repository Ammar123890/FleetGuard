				...
				<Col xs={12}>
					<Card>
						...
						<Card.Body>
							...
							<p className="text-muted mb-0">
								Nulla et mattis nunc. Curabitur scelerisque commodo condimentum.
								Mauris blandit, velit a consectetur egestas.
							</p>
						</Card.Body>
					</Card>
				</Col>
					...
					<Card>
						<Card.Header>
							...
							<p className="text-muted mb-0">
								...
								font styling of a heading but still want your text to be
								displayed inline.
							</p>
						</Card.Header>
						<Card.Body>
				...
				<Col xl={12}>
					<Card>
						<Card.Header>
							...
							<p className="text-muted mb-0">Available color variations.</p>
						</Card.Header>
						<Card.Body>
							<p className="text-muted">
					...
					<Card>
						<Card.Header>
							...
							<p className="text-muted mb-0">
								...
								<abbr title="AttexText Markup Language">HTML</abbr> as the
								quote.
							</p>
						</Card.Header>
						<Card.Body>
